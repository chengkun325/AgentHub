...
import com.chengkun.agenthub.mapper.ResourceMapper;
import com.chengkun.agenthub.mapper.RoleResourceMapper;
import com.chengkun.agenthub.service.ResourceService;
...
public class ResourceServiceImpl extends ServiceImpl<ResourceMapper, Resource> implements ResourceService {
    ...
    public void deleteResource(Integer resourceId) {
        Integer count = roleResourceMapper.selectCount(new LambdaQueryWrapper<RoleResource>()
                .eq(RoleResource::getResourceId, resourceId)).intValue();
        if (count > 0) {
