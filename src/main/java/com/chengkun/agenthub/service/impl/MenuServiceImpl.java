...
import com.chengkun.agenthub.mapper.MenuMapper;
import com.chengkun.agenthub.mapper.RoleMenuMapper;
...
import static com.chengkun.agenthub.constant.CommonConstant.COMPONENT;
...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements MenuService {
    ...
    public void deleteMenu(Integer menuId) {
        Integer count = roleMenuMapper.selectCount(new LambdaQueryWrapper<RoleMenu>()
                .eq(RoleMenu::getMenuId, menuId)).intValue();
        if (count > 0) {
